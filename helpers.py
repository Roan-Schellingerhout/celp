...
def distance(user_id, business_id):
    """Calculates the distance between a user and a business in km"""
    # radius of earth in km 
    R = 6373.0

    # find the longitude and latitude of both the user and business
    try:
...
def get_business(business_id):
    """Find business information based on business_id"""
    for city in CITIES:
...
def predict_vectors(user_ratings, similarities, n, cutoff):
    ...
    # if there's nothing left return a prediction of nan
